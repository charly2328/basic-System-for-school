<?php
	...
	if(isset($_POST['search']))
	{
		...
		$query = "SELECT * FROM carreras WHERE clave_carrera LIKE '%".$valueToSearh."%' OR nombre_carrera LIKE '%".$valueToSearh."%'";
...
<style>
    ...
    <h2>Carreras</h2>
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<td><a href='update.php?id=" . $row['clave_carrera'] ."'> <i class='bx bx-edit'> </i></a></td>";
            echo "<td><a href='delete.php?id=" . $row['clave_carrera']."'> <i class='bx bx-trash'> </i> </a></td>";
            echo "</tr>";
        }
        echo "</table>";
